...
printf "FROM 254144944163.dkr.ecr.ap-southeast-2.amazonaws.com/phenomics-prod:nginx-latest\nADD build /usr/share/nginx/html" > Dockerfile

echo 'Creating docker images.'
docker build --force-rm=true --tag=254144944163.dkr.ecr.ap-southeast-2.amazonaws.com/phenomics-prod:hippo-latest .
...
docker push 254144944163.dkr.ecr.ap-southeast-2.amazonaws.com/phenomics-prod:hippo-latest
echo 'Image uploaded'
